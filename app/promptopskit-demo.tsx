...
- create an interactive ThemeProvider using React context and prefers-color-scheme
...
const completion = await openAi.chat.completions.create(request.body);
